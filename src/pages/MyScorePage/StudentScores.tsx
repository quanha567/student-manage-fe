    ...
    return (
        <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
            ...
            >
                ...
                >
                    <RowData label="Mã SV" value={user?.student?.studentCode} />{' '}
                    <RowData
                        label="Lớp sinh hoạt"
                        value={
                            user?.student?.class?.data?.attributes?.className
                        }
                    />
                ...
                <div className="flex">
                    ...
                    <div className="flex-[2]">
                        <RowData
                            label="Khoa"
                            value={'Hệ thống thông tin và Viễn thám'}
                        />
                    </div>
                </div>
            </div>
                        ...
                        {data.groupedScores.map((semester) => (
                            <>
                                ...
                                >
                                    ...
                                    <td style={tableCellStyle} className="p-1">
