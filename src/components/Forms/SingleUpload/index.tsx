...
import TrashBinSvg from '~/assets/svg/trash-bin.svg';
                    ...
                    >
                      {fileUrl && !isDraggingFile && showPreview ? (
                        ...
                        <div className="flex flex-col items-center w-full py-2">
                          ...
                          {!isCompact && (
                            <>
                              <p className="text-current text-[10px] md:text-xs lg:text-sm text-center hidden md:block">
                                Kéo và thả file vào đây
                              </p>
                              <div className="w-2/5 mx-auto my-[4%] h-[1px] bg-current relative hidden md:block">
                          ...
                          {currentProgress ? (
                            ...
                            <div className="bg-zinc-200 text-zinc-700 font-bold p-[1%] text-sm rounded hover:bg-primary hover:text-white transition-all w-full max-w-[96px] text-center text-[10px] md:text-xs lg:text-sm hidden md:block">
                              CHỌN FILE
                            </div>
                          )}
                        </div>
...
export default FormSingleUpload;
